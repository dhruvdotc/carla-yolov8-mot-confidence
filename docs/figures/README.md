...
![Track lifetime histogram](track_lifetime_histogram.png)
...
![Average active tracks per frame](avg_active_tracks_per_frame.png)
...
![Average detections per frame](avg_detections_per_frame.png)
